  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-black text-black dark:text-white flex items-center justify-center transition-colors duration-300 ease-in-out">
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <input
          placeholder="Email"
          className="w-full border px-3 py-2 dark:text-black
          outline-none focus:outline-black focus:outline-offset-2 
          dark:outline-none dark:focus:outline-white dark:focus:outline-offset-2"
